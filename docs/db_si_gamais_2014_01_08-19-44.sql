...
CREATE TABLE IF NOT EXISTS `list_event` (
  ...
  `id_tipe_event` int(11) DEFAULT NULL COMMENT 'tipe event; 1 => mentoring, 2 => training, 3 => rapat, 4 => taklim',
  `id_kelompok` int(11) DEFAULT NULL,
  PRIMARY KEY (`id_event`),
  KEY `id_pj` (`id_pj`),
  KEY `id_tipe_event` (`id_tipe_event`),
  KEY `id_kelompok` (`id_kelompok`),
  CONSTRAINT `list_event_ibfk_2` FOREIGN KEY (`id_kelompok`) REFERENCES `list_kelompok` (`id_kelompok`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `list_event_ibfk_1` FOREIGN KEY (`id_pj`) REFERENCES `list_profil_anggota` (`id_anggota`) ON DELETE NO ACTION ON UPDATE CASCADE
...
INSERT INTO `list_event` (`id_event`, `nama`, `tanggal`, `id_pj`, `keterangan`, `id_tipe_event`, `id_kelompok`) VALUES
  ('1', 'Mentoring BKM 1', '2014-01-08', '1', NULL, NULL, NULL),
  ('2', 'Simfoni day 2', '2014-01-03', '1', NULL, NULL, NULL);
